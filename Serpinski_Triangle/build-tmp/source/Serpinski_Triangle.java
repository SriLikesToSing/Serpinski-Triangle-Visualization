...
public class Serpinski_Triangle extends PApplet {
...
public void first_tri(){
   fill(255);
   triangle( global_x1,  global_y1,  global_x2,  global_y2,  global_x3,  global_y3);
}
public void second_tri(){
   fill(0);
   triangle(main_x1, main_y1, main_x2, main_y2, main_x3, main_y3);
}
 public void upsidedowntri(float x1, float y1, float x2, float y2, float x3, float y3, float layer, float layer_limit){
...
public void mouseWheel(MouseEvent e)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Serpinski_Triangle" };
    if (passedArgs != null) {
